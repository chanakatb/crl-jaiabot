...
time_values = np.load('final_results/20250320_082540_timing_values.npy')
beeta_values = np.load('final_results/20250320_082540_beta_values.npy')
gamma_values = np.load('final_results/20250320_082540_gamma_values.npy')
phi_values = np.load('final_results/20250320_082540_phi_values.npy')
min_values = np.load('final_results/20250320_082540_min_dist_from_beta_values.npy')
...
plt.grid(True)
plt.xlim(0, max(time_values))
# plt.savefig('graph/beta_plot_field.pdf', format='pdf', dpi=300, 
#             bbox_inches='tight', pad_inches=0.1)
# plt.savefig('graph/beta_plot_field.png', format='png', dpi=300, 
#             bbox_inches='tight', pad_inches=0.1)
# plt.show()
...
# Save the figure
plt.savefig('graph/min_dist_and_beta_field.pdf', format='pdf', dpi=300, 
            bbox_inches='tight', pad_inches=0.1)
plt.savefig('graph/min_dist_and_beta_field.png', format='png', dpi=300, 
            bbox_inches='tight', pad_inches=0.1)
...
plt.grid(True)
plt.xlim(0, max(time_values))
plt.savefig('graph/gamma_plot_field.pdf', format='pdf', dpi=300, 
            bbox_inches='tight', pad_inches=0.1)
plt.savefig('graph/gamma_plot_field.png', format='png', dpi=300, 
            bbox_inches='tight', pad_inches=0.1)
plt.show()
...
plt.grid(True)
plt.xlim(0, max(time_values))
plt.savefig('graph/phi_plot_field.pdf', format='pdf', dpi=300, 
            bbox_inches='tight', pad_inches=0.1)
plt.savefig('graph/phi_plot_field.png', format='png', dpi=300, 
            bbox_inches='tight', pad_inches=0.1)
plt.show()
