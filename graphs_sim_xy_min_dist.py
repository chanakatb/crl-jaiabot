...
# Define the dataset
data = np.load('data/final_results/20250320_082540_x_array.npy')
time_val = np.load('data/final_results/20250320_082540_timing_values.npy')
...
class AnimationManager:
    ...
    def save_frame(self, frame, positions, closest_boundary_points, min_distance, 
        ...
        # Save files
        plt.savefig(f'graph/frame_sim_{frame:03d}.pdf', format='pdf', dpi=300, 
                   bbox_inches='tight', pad_inches=0.1)
        plt.savefig(f'graph/frame_sim_{frame:03d}.png', format='png', dpi=300, 
                   bbox_inches='tight', pad_inches=0.1)
...
time_values = np.arange(len(min_distance_values)) * time_factor
